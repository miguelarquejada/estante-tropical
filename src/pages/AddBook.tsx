  ...
  useEffect(() => {
    ...
    const t = setTimeout(async () => {
      ...
      try {
        ...
        if (e instanceof BookSearchQuotaError) setError('A busca atingiu o limite diário da Google Books API. Tente mais tarde, configure uma chave (VITE_GOOGLE_BOOKS_KEY) ou cadastre manualmente.')
